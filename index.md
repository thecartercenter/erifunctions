...
| [Answering ad-hoc requests with SQL](https://thecartercenter.github.io/erifunctions/articles/da-adhoc-guide.html) | Data analysts running SQL across approved datasets (roll-ups, joins) with the [`eri_query()`](https://thecartercenter.github.io/erifunctions/reference/eri_query.md) DuckDB layer |
