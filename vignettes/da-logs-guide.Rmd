...
The `2024-01` data-quality flags from §1 are still just sitting there, unresolved — let's actually
finish that one so the trail below has something worth showing: fix one flag, note the other, and
approve:
