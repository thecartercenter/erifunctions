...
- [`erifunctions_io()`](https://thecartercenter.github.io/erifunctions/reference/erifunctions_io.md)
  **\[experimental\]** : Legacy I/O handler for the erifunctions data
  interface
...
- [`eri_dq_review_note()`](https://thecartercenter.github.io/erifunctions/reference/eri_dq_review_note.md)
  **\[experimental\]** : Log a free-text note against a CMR period,
  outside of any single DQ flag
...
- [`eri_dq_flag_resolve()`](https://thecartercenter.github.io/erifunctions/reference/eri_dq_flag_resolve.md)
  **\[experimental\]** :
  ...
  Triage a single DQ flag within a logged
  [`eri_dq_log()`](https://thecartercenter.github.io/erifunctions/reference/eri_dq_log.md)
  entry
